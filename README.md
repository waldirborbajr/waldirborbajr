...
* [tmux-docker](https://github.com/waldirborbajr/tmux-docker) - A tmux plugin that displays the names of running Docker containers on a remote server in the status bar, refreshing every 10 seconds.
